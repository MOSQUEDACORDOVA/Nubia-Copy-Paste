                                            ...
                                            if (pedidos_letG[i].total_garrafones_pedido <= 2) {
                                                ...
                                                if (duration >= 10 && duration < 20) {
                                                    notif1_2.push({
                                                        ...
                                                        asentamiento: pedidos_letG[i].cliente.cp.asentamiento,
                                                    });
                                                }
                                            }
                                            if (
                                                        ...
                                                        .then((etiquetas_) => {
                                                            ...
                                                            LastPedidosAll(id_sucursal)
                                                                .then(async(pedidos_g) => {
                                                                    ...
                                                                    var duration = "";
                                                                    for (
                                                                        let i = 0; i < pedidos_letG.length; i++
                                                                    ) {
                                                                        if (
                                                                            ...
                                                                            if (
                                                                                ...
                                                                                if (duration >= 10 && duration < 20) {
                                                                                    notif1_2.push({
                                                                                        ...
                                                                                        fecha_: pedidos_letG[i].fecha_pedido,
                                                                                        tiempo_desde: duration,
                                                                                        asentamiento: pedidos_letG[i].cliente.cp
                                                                                            .asentamiento,
                                                                                    });
                                                                                }
                                                                            }

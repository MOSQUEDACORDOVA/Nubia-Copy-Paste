...
exports.sesionstart =async (req, res) => {
  console.log("🚀 ~ file: apiPY4.js ~ line 564 ~ exports.sesionstart= ~ req.body", req.body)
  const {email, password} = req.body;
   let Usuarios = require('../models/PYT4/Usuarios');	
   let Personal = require('../models/PYT4/Personal');	
  
      try {
        const usuario = await Usuarios.findOne({
          where: {email: email},
         include:[
          {association:Usuarios.Personal }
        ],},);
        console.log("🚀 ~ file: apiPY4.js ~ line 571 ~ exports.sesionstart= ~ usuario", usuario)
...
exports.obtenerPedidos = async (req, res)=>{
  let dia;
    if (req.params.day) {
      dia = moment(req.params.day, "YYYY-MM-DD").format("YYYY-MM-DD");
    } else {
      dia = moment().format("YYYY-MM-DD");
    }
    console.log("🚀 ~ file: apiPY4.js ~ line 43 ~ exports.obtenerPedidos= ~ dia", dia)

    let personalId = req.params.personalId
    console.log("🚀 ~ file: apiPY4.js ~ line 49 ~ exports.obtenerPedidos= ~ personalId", personalId)
   let PedidosDB = DataBase.PedidosChoferbyDia;
    let pedidos = JSON.parse (await PedidosDB(dia,personalId))
    console.log("🚀 ~ file: apiPY4.js ~ line 53 ~ exports.obtenerPedidos= ~ pedidos", pedidos)
    res.send({pedidos})
  }

...
const DataBase = require("../../models/PYT28/data");
const Usuarios = require("../../models/PYT28/Usuarios");
const Depositos = require("../../models/PYT28/DepositosAero");
...
exports.sesionstart = (req, res) => {
  ...
  passport.authenticate("local", async function (err, user, info) {
    ...
    if (!user) {
      ...
      return res.redirect("/login28/PYT-28");
    } else {
    ...
    req.logIn(user, function (err) {
      ...
      return res.redirect('/controlrolespy28/PYT-28')
    });
  })(req, res);
};
...
exports.formLogin = async (req, res) => {
  ...
  if (req.params.token) {
    ...
    return res.redirect("/emailverifynotifypy28/"+usuario.id);
  }
}

// Registro de usuarios
exports.reguserpy28 = async (req, res) => {
  console.log(req.body);
  ...
  if (fname.trim() === '' || lname.trim() === '' || bdate.trim() === '' || gender.trim() === '' || dtype.trim() === '' || numdoc.trim() === '' || nationality.trim() === '' || country.trim() === '' || city.trim() === '' || phone.trim() === '' || address.trim() === '' || username.trim() === '' || email.trim() === '' || password.trim() === '') {
    ...
    res.redirect('/register28/PYT-28');
  } else {
    let usuario;
    ...
    if(usuario) {
      ...
      console.log("error")
      return res.redirect("/register28/PYT-28");
    }
    ...
    DataBase.RegUser(fname, lname, bdate, gender, dtype, numdoc, nationality, country, city, phone, address, username, email, password).then(async (respuesta) =>{
      ...
      res.redirect("/mailBienvenidapy28/"+email+"/" + usuario.token);
      
    }).catch((err) => {
      console.log(err)
      let msg = "Error en sistema";
      return res.redirect("/error404/PYT-28");
    });
  }
};

// REGISTRO DE REFERIDOS
exports.reguserreferpy28 = (req, res) => {
  console.log(req.body);
...
exports.verifypackges = (req, res) => {
  ...
  DataBase.GetAllDepositsAdmin().then((resp) => {
    ...
    return res.redirect("/py28/PYT-28");
  }).catch((err) => {
    console.log(err)
    let msg = "Error en sistema";
    return res.redirect("/error28/PYT-28");
...
exports.verifypackgesuser = (req, res) => {
  ...
  DataBase.GetAllDepositsUser(idUser).then((resp) => {
    ...
    return res.redirect("/boardpresale/PYT-28");
  }).catch((err) => {
    console.log(err)
    let msg = "Error en sistema";
    return res.redirect("/error28/PYT-28");
...
exports.emailregsend = (req, res) => {
  ...
  console.log(proyecto)
    ...
    res.render(proyecto+"/mail/welcome", {
      pageName: "Minner - Email Register",
      dashboardPage: true,
      dashboard: true,
      py28: true,
      login: true,
...
exports.emaildeposit = (req, res) => {
  ...
  console.log(proyecto)
    ...
    res.render(proyecto+"/mail/deposits", {
      pageName: "Minner - Confirm Deposits",
      dashboardPage: true,
      dashboard: true,
      py28: true,
      login: true,
...
exports.emailretreats = (req, res) => {
  ...
  console.log(proyecto)
    ...
    res.render(proyecto+"/mail/retreats", {
      pageName: "Minner - Confirm Retreats",
      dashboardPage: true,
      dashboard: true,
      py28: true,
      login: true,
...
exports.referregister = (req, res) => {
  ...
  res.render("PYT-28/auth/registerrefer", {
    pageName: "Registro",
    dashboardPage: true,
    dashboard: true,
    py28: true,
...
exports.solicitpay = (req, res) => {
  ...
  DataBase.SolicitPay(id).then((resp)=>{
    return res.redirect('retreats28/PYT-28');
  }).catch((err) => {
    console.log(err)
    let msg = "Error en sistema";
    return res.redirect("/error28/PYT-28");
...
exports.payuser = (req, res) => {
  ...
  DataBase.PayUser(id, methodid).then((resp)=> {
    ...
    DataBase.CulminateDeposits(depid).then((resp2) => {
      ...
      return res.redirect('paym/PYT-28');
    }).catch((err) => {
...
exports.getuserinfopy28 = (req, res) => {
  let msg = false;
  if (req.query.msg) {
    msg = req.query.msg;
  }
...
exports.verifyuser = (req, res) => {
  ...
  DataBase.VerifyUser(id).then((users)=>{
    return res.redirect('userspy28/PYT-28');
  }).catch((err) => {
    console.log(err)
    let msg = "Error en sistema";
    return res.redirect("/error28/PYT-28");
...
exports.solicitverify = (req, res) => {
  ...
  DataBase.SolicitVerify(id, voucher1, voucher2).then((users)=>{
    return res.redirect('boardpresalepy28/PYT-28');
  }).catch((err) => {
    console.log(err)
    let msg = "Error en sistema";
    return res.redirect("/error28/PYT-28");
...
exports.updatepaymethod = (req, res) => {
  ...
  if(req.body.ttype === 'Transferencia Bancaria') {
    DataBase.UpdatePayMethodTransf(id, ttype, name, dni, bank, type_account, num_account, phone, code_wallet, email_wallet).then((respuesta) =>{
      res.redirect('/paymethodspy28/PYT-28')
    }).catch((err) => {
      console.log(err)
      let msg = "Error en sistema";
      return res.redirect("/error28/PYT-28");
...
exports.forgotpassword = (req, res) => {
  ...
  res.render(proyecto+"/mail/forgotpassword", {
    pageName: "Minner - Forgot you password",
    dashboardPage: true,
    dashboard: true,
    py28: true,
    login: true,
  ...
  if (email.trim() === "") {
    ...
    function FindUser (email) {
      return new Promise((resolve, reject) => {
        ...
        return res.redirect("/mailBienvenidapy28/"+email+"/" + token);
...
exports.updateprofile = (req, res) => {
  ...
  DataBase.UpdateProfileUser(id, firstName, lastName, dateOfBirth, gender, typedoc, num_doc, nationality, country, city, phone, address, username, email, status).then((response) => {
    ...
    return res.redirect("/profile28/PYT-28");
  }).catch((err) => {
    console.log(err)
    let msg = "Error en sistema";
    return res.redirect("/error28/PYT-28");
  ...
  DataBase.UpdateDepositsAero(depid, activated).then((response) => {
    ...
    DataBase.GetBalanceCoinsUser(id).then((resp) => {
      ...
      DataBase.GiveCoinsToUser(id, total).then(() => {      
          res.redirect(`/mailDepositApprovey28/${userid}/${amountAero}`);
      }).catch((err) => {
        console.log(err)
        let msg = "Error en sistema";
        return res.redirect("/error28/PYT-28");
...
exports.rejectdeposit = (req, res) => {
  ...
  DataBase.RejectDeposit(id).then((response) => {
    ...
    console.log("THEN")
    return res.redirect('/mailDepositRejectedpy28/'+id);
  })
  .catch((err) => {
    console.log(err)
    let msg = "Error en sistema";
...
exports.createpackages = (req, res) => {
  ...
  if (name.trim() === '' || price.trim() === '' || duration.trim() === '' || amount.trim() === '' || maintance.trim() === '') {
    ...
    DataBase.CreatePackages(name, price, duration, amount, maintance).then((respuesta) =>{
      ...
      console.log(err)
      let msg = "Error en sistema";
      return res.redirect("/error404/PYT-28" + msg);
    });
  };
}
...
exports.addbank = (req, res) => {
  ...
  if (fullname.trim() === '' || dni.trim() === '' || bank_name.trim() === '' || type_account.trim() === '' || num_account.trim() === '') {
    console.log('complete todos los campos')
    res.redirect('/paymethods28/PYT-28');
  } else {
...
exports.addretreatsbank = (req, res) => {
  ...
  if (fullname.trim() === '' || dni.trim() === '' || bank_name.trim() === '' || type_account.trim() === '' || num_account.trim() === '') {
    console.log('complete todos los campos')
    res.redirect('/retreats28/PYT-28');
  } else {

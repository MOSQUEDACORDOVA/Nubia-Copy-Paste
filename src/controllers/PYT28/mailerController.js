...
exports.bienvenidaMail = async function (req, res) {
    ...
    const resetUrl = `http://${req.headers.host}/loginverify28/${token}`;
    ...
    transporter.sendMail(mailOptions, function (error, info) {
      if (error) {
        ...
        res.redirect("/emailregsend/PYT-28/"+emailUser);
                      ...
                      <tbody><tr>
                        <td class="sm-px-24" style="--bg-opacity: 1; background-color: #ffffff; background-color: rgba(255, 255, 255, var(--bg-opacity)); border-radius: 4px; font-family: Montserrat, -apple-system, 'Segoe UI', sans-serif; font-size: 14px; line-height: 24px; padding: 48px; text-align: left; --text-opacity: 1; color: #626262; color: rgba(98, 98, 98, var(--text-opacity));" bgcolor="rgba(255, 255, 255, var(--bg-opacity))" align="left">
                          ...
                          <table style="font-family: 'Montserrat',Arial,sans-serif;" cellpadding="0" cellspacing="0" role="presentation">
                              <tbody><tr>
                                <td style="mso-padding-alt: 16px 24px; --bg-opacity: 1; background-color: #04246d; background-color: #04246d; border-radius: 4px; font-family: Montserrat, -apple-system, 'Segoe UI', sans-serif; ">
                                  <a href="https://aerocoin.us/login28/PYT-28" style="display: block; font-weight: 600; font-size: 14px; line-height: 100%; padding: 16px 24px; --text-opacity: 1; color: #ffffff; text-decoration: none;">Sign In</a>
                                </td>
                              </tr>
                          </tbody></table>
